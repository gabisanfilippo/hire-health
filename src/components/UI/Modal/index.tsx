...
export const Modal = ({ onClose, title, content }: IProps) => {
  return (
    <span className="fixed z-40 top-0 left-0 w-screen h-screen flex items-center justify-center sm:px-8 px-4 py-8 backdrop-blur-lg">
      <section className="bg-custom-white sm:p-8 p-4 shadow rounded-md flex flex-col gap-4 sm:min-w-96 sm:w-max w-full max-h-full overflow-auto">
